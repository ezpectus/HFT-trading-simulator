...
- Name: trading.spec.js >> Trading System UI — Trading Flows >> can toggle sidebar with Shift+\
- Location: e2e\trading.spec.js:34:3
...
Locator: getByRole('button', { name: /Expand sidebar/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Expand sidebar/i })
...
- application "HFT Trading System Dashboard":
  ...
  - main:
    ...
    - tabpanel:
      ...
      - img
      - text: "Win Rate 0.0% (0W/0L) Fills received: 10"
      - button "Reset"
      - img
      ...
      - img
      - text: Normal trading frequency Total Fills 10 Avg Interval 0s Max 5min 10 Trade Clusters (≥3 rapid fills) 10 fills 2.006999969482422s span BUY
      - img
      ...
      - text: R:R
      - spinbutton: "2"
      - text: "Risk of Ruin 0.00% MC: 0.0% Edge +35.00% Profit Factor 1.64 BE Win Rate 33.3% Current WR 45.0% Monte Carlo Drawdown (100 trades): Avg Max DD 15.8% Median 15.0% Worst 36.6% Sample equity curves:"
      - img
      ...
      - text: Risk %
      - spinbutton: "1"
      - text: "EV per Trade +0.350% ≈ $35.00 per $10K Profit Factor 1.64 BE Win Rate 33.3% Kelly % 17.5% P(5 loss) 5.03% Per Strategy EV: market_making 0t 0% +0.00% stat_arb 0t 0% +0.00% ml_ensemble 0t 0% +0.00% trend_following 0t 0% +0.00% mean_reversion 0t 0% +0.00% EV = (WR × R:R - LR) × risk%. Positive EV = profitable system. Kelly = optimal bet size."
      - img
    ...
    - tabpanel:
      ...
      - img
      - text: Binomial Price $3.2377 LSM Price $3.3263 European $3.1229 Early Ex. Premium $0.2035 Intrinsic $0.0000
      - strong: "Model:"
    ...
    - tabpanel:
      ...
      - img
      - text: Session Export Fills 10 Candles 500 Signals 10 Accounts 3
    ...
    - img
    - text: "-- -- win Balance $10,000.00 Equity $9,995.47 Total PnL -- Fees -- Trades Positions 0 okx"
    - img
    - text: "-- -- win Balance $10,000.00 Equity $10,000.52 Total PnL -- Fees -- Trades Positions 0 Open Positions (4) L:1 S:3 Margin: $379.68 -$4.02 SHORT SOLUSDT binance 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0177 Entry: $144.80 PnL: -$0.00 Margin: $0.26 SL: $-- TP: $-- Liq: $158.56 SHORT BTCUSDT bybit 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0549 Entry: $64,917.45 PnL: -$4.53 Margin: $356.40 SL: $-- TP: $-- Liq: $71,084.60 LONG ETHUSDT okx 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0619 Entry: $3,490.97 PnL: $0.56 Margin: $21.61 SL: $-- TP: $-- Liq: $3,159.33 SHORT SOLUSDT okx 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0982 Entry: $144.60 PnL: -$0.04 Margin: $1.42 SL: $-- TP: $-- Liq: $158.34"
  - contentinfo "System status bar":
    - text: 05:40:37 0 candles binance · BTC/USDT
    - img
    - text: "AI: 10 sigs"
    - img
    - text: "10 fills Pos: 0 Trades: 0 Balance: $30000"
    - img
    - text: "-4.02 EXCELLENT"
    - img
    - text: EX 0ms

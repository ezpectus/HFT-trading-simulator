...
- Name: trading.spec.js >> Trading System UI — Trading Flows >> can switch tabs via keyboard shortcuts
- Location: e2e\trading.spec.js:24:3
...
Locator: getByRole('tab', { name: /Signals/i })
Expected: "true"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('tab', { name: /Signals/i })
...
- application "HFT Trading System Dashboard":
  ...
  - main:
    ...
    - tabpanel:
      ...
      - img
      - text: Normal trading frequency Total Fills 10 Avg Interval 0s Max 5min 10 Trade Clusters (≥3 rapid fills) 10 fills 1.99399995803833s span BUY
      - img
      ...
      - text: R:R
      - spinbutton: "2"
      - text: "Risk of Ruin 0.00% MC: 0.2% Edge +35.00% Profit Factor 1.64 BE Win Rate 33.3% Current WR 45.0% Monte Carlo Drawdown (100 trades): Avg Max DD 15.3% Median 14.9% Worst 36.9% Sample equity curves:"
      - img
      ...
      - text: Risk %
      - spinbutton: "1"
      - text: "EV per Trade +0.350% ≈ $35.00 per $10K Profit Factor 1.64 BE Win Rate 33.3% Kelly % 17.5% P(5 loss) 5.03% Per Strategy EV: mean_reversion 0t 0% +0.00% stat_arb 0t 0% +0.00% market_making 0t 0% +0.00% ml_ensemble 0t 0% +0.00% sentiment 0t 0% +0.00% EV = (WR × R:R - LR) × risk%. Positive EV = profitable system. Kelly = optimal bet size."
      - img
    ...
    - tabpanel:
      ...
      - img
      - text: Binomial Price $3.2377 LSM Price $3.3137 European $3.0625 Early Ex. Premium $0.2512 Intrinsic $0.0000
      - strong: "Model:"
    ...
    - img
    - text: "-- -- win Balance $10,000.00 Equity $10,000.97 Total PnL -- Fees -- Trades Positions 0 okx"
    - img
    - text: "-- -- win Balance $10,000.00 Equity $10,000.00 Total PnL -- Fees -- Trades Positions 0 Open Positions (2) L:1 S:1 Margin: $106.05 +$0.97 SHORT BTCUSDT bybit 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0163 Entry: $65,059.58 PnL: $0.97 Margin: $106.05 SL: $-- TP: $-- Liq: $71,240.24 LONG ADAUSDT bybit 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0351 Entry: $0.45 PnL: -$0.00 Margin: $0.00 SL: $-- TP: $-- Liq: $0.41"

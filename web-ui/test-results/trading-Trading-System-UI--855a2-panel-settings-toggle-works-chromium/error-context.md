...
- Name: trading.spec.js >> Trading System UI — Trading Flows >> panel settings toggle works
- Location: e2e\trading.spec.js:81:3
...
Locator: getByText('Toggle Panels').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Toggle Panels').first()
...
- application "HFT Trading System Dashboard":
  ...
  - region "Notifications":
    - alert:
      - text: "Strong signal: LONG ADAUSDT (78% confidence)"
  ...
  - main:
    ...
    - tabpanel:
      ...
      - img
      - text: "Win Rate 0.0% (0W/0L) Fills received: 5"
      - button "Reset"
      - img
      ...
      - img
      - text: Normal trading frequency Total Fills 5 Avg Interval 1s Max 5min 5 Trade Clusters (≥3 rapid fills) 5 fills 2.001999855041504s span SELL
      - img
      ...
      - text: R:R
      - spinbutton: "2"
      - text: "Risk of Ruin 0.00% MC: 0.0% Edge +35.00% Profit Factor 1.64 BE Win Rate 33.3% Current WR 45.0% Monte Carlo Drawdown (100 trades): Avg Max DD 15.3% Median 13.8% Worst 33.4% Sample equity curves:"
      - img
      ...
      - text: Risk %
      - spinbutton: "1"
      - text: "EV per Trade +0.350% ≈ $35.00 per $10K Profit Factor 1.64 BE Win Rate 33.3% Kelly % 17.5% P(5 loss) 5.03% Per Strategy EV: mean_reversion 0t 0% +0.00% stat_arb 0t 0% +0.00% trend_following 0t 0% +0.00% market_making 0t 0% +0.00% sentiment 0t 0% +0.00% EV = (WR × R:R - LR) × risk%. Positive EV = profitable system. Kelly = optimal bet size."
      - img
    ...
    - tabpanel:
      ...
      - img
      - text: Binomial Price $3.2377 LSM Price $3.3137 European $3.2969 Early Ex. Premium $0.0168 Intrinsic $0.0000
      - strong: "Model:"
    ...
    - tabpanel:
      ...
      - img
      - text: Session Export Fills 5 Candles 500 Signals 11 Accounts 3
    ...
    - img
    - text: "-- -- win Balance $10,000.00 Equity $10,000.00 Total PnL -- Fees -- Trades Positions 0 bybit"
    - img
    - text: "-- -- win Balance $10,000.00 Equity $9,998.04 Total PnL -- Fees -- Trades Positions 0 okx"
    - img
    - text: "-- -- win Balance $10,000.00 Equity $10,000.08 Total PnL -- Fees -- Trades Positions 0 Open Positions (4) L:2 S:2 Margin: $310.13 -$1.87 SHORT ETHUSDT bybit 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0448 Entry: $3,494.08 PnL: -$0.27 Margin: $15.65 SL: $-- TP: $-- Liq: $3,826.01 SHORT BTCUSDT bybit 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.0442 Entry: $64,961.77 PnL: -$1.69 Margin: $287.13 SL: $-- TP: $-- Liq: $71,133.13 LONG ETHUSDT okx 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.021 Entry: $3,496.04 PnL: $0.08 Margin: $7.34 SL: $-- TP: $-- Liq: $3,163.91 LONG DOGEUSDT okx 10x"
    - button "Close position":
      - img
    - text: "Qty: 0.059 Entry: $0.12 PnL: $0.00 Margin: $0.00 SL: $-- TP: $-- Liq: $0.11"
  - contentinfo "System status bar":
    - text: 05:40:40 0 candles binance · BTC/USDT
    - img
    - text: "AI: 11 sigs"
    - img
    - text: "5 fills Pos: 0 Trades: 0 Balance: $30000"
    - img
    - text: "-1.87 EXCELLENT"
    - img
    - text: EX 0ms

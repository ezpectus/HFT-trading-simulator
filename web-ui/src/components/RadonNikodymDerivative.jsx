    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex items-center gap-3 flex-wrap text-xs">
        ...
        <label className="flex items-center gap-1">
          ...
          <input type="number" value={lookback} onChange={e => setLookback(Math.max(80, +e.target.value))} className="w-16 px-1 bg-slate-800 border border-slate-600  text-slate-200" />
        </label>
      </div>

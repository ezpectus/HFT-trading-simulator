...
export const PANELS = [
  ...
  { id: 'liquidity-heatmap', name: 'Liquidity Heatmap', category: 'orderflow', component: LiquidityHeatmap,
    props: (ctx) => ({ orderbookData: ob(ctx)}) },
  ...
  { id: 'trade-replay', name: 'Trade Replay', category: 'orderflow', component: TradeReplay,
    props: (ctx) => ({ fills: ctx.exchange.fills, candles: ctx.exchange.candles, accounts: ctx.exchange.accounts, symbol: ctx.selectedSymbol, selectedExchange: ctx.selectedExchange }) },
  ...
  { id: 'indicator-builder', name: 'Custom Indicator Builder', category: 'technical', component: IndicatorBuilder,
    props: (ctx) => ({ candles: ctx.chartCandles, onIndicatorsChange: ctx.setCustomIndicators }) },
  ...
  { id: 'funding-history', name: 'Funding Rate History', category: 'technical', component: FundingRateHistory,
    props: (ctx) => ({ fundingRates: ctx.exchange.fundingRates, candlesToFunding: ctx.exchange.candlesToFunding, prices: ctx.exchange.prices, symbols: ctx.SYMBOLS, sendSignalMessage: ctx.signals.sendSignalMessage, fundingArbResult: ctx.signals.fundingArbResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'inter-exchange-spread', name: 'Inter-Exchange Spread', category: 'technical', component: InterExchangeSpread,
    props: (ctx) => ({ candles: ctx.exchange.candles, prices: ctx.exchange.prices, symbols: ctx.SYMBOLS}) },
  ...
  { id: 'risk-dashboard', name: 'Risk Dashboard (VaR/CVaR)', category: 'risk', component: RiskDashboard,
    props: (ctx) => ({ accounts: ctx.exchange.accounts, candles: ctx.exchange.candles, exchange: ctx.selectedExchange, prices: ctx.exchange.prices, sendSignalMessage: ctx.signals.sendSignalMessage, stressTestResult: ctx.signals.stressTestResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'slippage-sim', name: 'Slippage Simulator', category: 'risk', component: SlippageSimulator,
    props: (ctx) => ({ candles: ctx.exchange.candles, orderbooks: ctx.exchange.orderbooks, currentPrice: ctx.currentPrice, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange }) },
  ...
  { id: 'hawkes', name: 'Hawkes Process (Trade Clustering)', category: 'risk', component: HawkesProcess,
    props: (ctx) => ({ candles: ctx.exchange.candles, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange, sendSignalMessage: ctx.signals.sendSignalMessage, hawkesResult: ctx.signals.hawkesResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'cvar', name: 'Conditional VaR (Expected Shortfall)', category: 'portfolio', component: ConditionalValueAtRisk,
    props: (ctx) => ({ candles: ctx.exchange.candles, symbols: ctx.SYMBOLS, exchange: ctx.selectedExchange, sendSignalMessage: ctx.signals.sendSignalMessage, cvarResult: ctx.signals.cvarResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'smart-router', name: 'Smart Order Router', category: 'portfolio', component: SmartOrderRouter,
    props: (ctx) => ({ candles: ctx.exchange.candles, orderbooks: ctx.exchange.orderbooks, symbols: ctx.SYMBOLS, exchanges: ctx.EXCHANGES}) },
  ...
  { id: 'position-optimizer', name: 'Position Size Optimizer', category: 'portfolio', component: PositionSizeOptimizer,
    props: (ctx) => ({ candles: ctx.exchange.candles, accounts: ctx.exchange.accounts, currentPrice: ctx.currentPrice, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange, sendSignalMessage: ctx.signals.sendSignalMessage, positionSizeResult: ctx.signals.positionSizeResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'competition', name: 'Strategy Competition', category: 'strategy', component: CompetitionFramework,
    props: (ctx) => ({ sendSignalMessage: ctx.signals.sendSignalMessage, backtestResult: ctx.signals.backtestResult, connected: ctx.signals.connected, candles: ctx.exchange.candles, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange }) },
  ...
  { id: 'backtest-runner', name: 'Backtest Runner', category: 'strategy', component: BacktestRunner,
    props: (ctx) => ({ symbol: ctx.selectedSymbol, connected: ctx.signals.connected, sendSignalMessage: ctx.signals.sendSignalMessage, backtestResult: ctx.signals.backtestResult }) },
  ...
  { id: 'audit-log', name: 'Audit Log Viewer', category: 'config', component: AuditLogViewer,
    props: (ctx) => ({ auditLogs: ctx.exchange.auditLogs }) },
  { id: 'bot-status', name: 'Bot Status Monitor', category: 'config', component: BotStatus,
    props: (ctx) => ({ signals: ctx.signals.signals, fills: ctx.exchange.fills, accounts: ctx.exchange.accounts, signalConnected: ctx.signals.connected, exchangeConnected: ctx.exchange.connected, circuitBreaker: ctx.signals.circuitBreaker, tradingActive: ctx.exchange.tradingActive }) },
  ...
  { id: 'news-feed', name: 'News Feed', category: 'config', component: NewsFeed,
    props: (ctx) => ({ newsEvent: ctx.exchange.newsEvent }) },
  ...
  { id: 'tax-report', name: 'Tax Report', category: 'export', component: TaxReport,
    props: (ctx) => ({ accounts: ctx.exchange.accounts, addToast: (type, msg) => ctx.addToast({ type, title: msg }) }) },
  ...
  { id: 'market-impact', name: 'Market Impact Analysis', category: 'risk', component: MarketImpact,
    props: (ctx) => ({ candles: ctx.exchange.candles, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange, currentPrice: ctx.currentPrice, orderbooks: ctx.exchange.orderbooks }) },
  { id: 'inventory', name: 'Inventory Manager', category: 'portfolio', component: Inventory,
    props: (ctx) => ({ accounts: ctx.exchange.accounts, prices: ctx.exchange.prices}) },
  ...
  { id: 'api-playground', name: 'API Playground', category: 'config', component: ApiPlayground,
    props: (ctx) => ({ addToast: (type, msg) => ctx.addToast({ type, title: msg }) }) },
  { id: 'data-quality', name: 'Data Quality Monitor', category: 'config', component: DataQuality,
    props: (ctx) => ({ candles: ctx.exchange.candles, exchange: ctx.selectedExchange, symbol: ctx.selectedSymbol }) },
  { id: 'log-dashboard', name: 'Log Dashboard', category: 'config', component: LogDashboard,
    props: () => ({}) },
  { id: 'audit-trail', name: 'Audit Trail', category: 'config', component: AuditTrail,
    props: (ctx) => ({ fills: ctx.exchange.fills, signals: ctx.signals.signals }) },
  ...
  { id: 'microstructure', name: 'Microstructure Analysis', category: 'orderflow', component: Microstructure,
    props: (ctx) => ({ symbol: ctx.selectedSymbol, orderbooks: ctx.exchange.orderbooks, exchange: ctx.selectedExchange }) },
  { id: 'tick-replay', name: 'Tick Replay', category: 'orderflow', component: TickReplay,
    props: (ctx) => ({ symbol: ctx.selectedSymbol, fills: ctx.exchange.fills}) },
  ...
  { id: 'futures-basis', name: 'Futures Basis', category: 'risk', component: FuturesBasis,
    props: (ctx) => ({ currentPrice: ctx.currentPrice, fundingRates: ctx.exchange.fundingRates, prices: ctx.exchange.prices, symbol: ctx.selectedSymbol }) },
  { id: 'vol-surface', name: 'Volatility Surface', category: 'risk', component: VolSurface,
    props: (ctx) => ({ candles: ctx.exchange.candles, exchange: ctx.selectedExchange, symbol: ctx.selectedSymbol, sendSignalMessage: ctx.signals.sendSignalMessage, volSurfaceResult: ctx.signals.volSurfaceResult, signalsConnected: ctx.signals.connected, optionsChain: ctx.exchange.optionsChain, requestOptionsChain: ctx.exchange.requestOptionsChain }) },
  ...
  { id: 'regime-detector', name: 'Regime Detector', category: 'risk', component: RegimeDetector,
    props: (ctx) => ({ symbol: ctx.selectedSymbol, candles: ctx.exchange.candles, regime: ctx.signals.regime, exchange: ctx.selectedExchange }) },
  ...
  { id: 'slippage-analytics', name: 'Slippage Analytics', category: 'risk', component: SlippageAnalytics,
    props: (ctx) => ({ symbol: ctx.selectedSymbol, fills: ctx.exchange.fills, candles: ctx.exchange.candles, exchange: ctx.selectedExchange }) },
  { id: 'strategy-correlation', name: 'Strategy Correlation', category: 'risk', component: StrategyCorrelation,
    props: (ctx) => ({ signals: ctx.signals.signals}) },
  { id: 'walk-forward-viewer', name: 'Walk-Forward Viewer', category: 'strategy', component: WalkForwardViewer,
    props: (ctx) => ({ backtestResult: ctx.signals.backtestResult }) },
  ...
  { id: 'cost-basis', name: 'Cost Basis Tracker', category: 'portfolio', component: CostBasis,
    props: (ctx) => ({ fills: ctx.exchange.fills, accounts: ctx.exchange.accounts, prices: ctx.exchange.prices, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange }) },
  ...
  { id: 'liquidity-map-3d', name: 'Liquidity Map 3D', category: 'orderflow', component: LiquidityMap3D,
    props: (ctx) => ({ currentPrice: ctx.currentPrice, orderbooks: ctx.exchange.orderbooks, exchange: ctx.selectedExchange, symbol: ctx.selectedSymbol }) },
  { id: 'signal-tracker', name: 'Signal Tracker', category: 'strategy', component: SignalTracker,
    props: (ctx) => ({ signals: ctx.signals.signals, prices: ctx.exchange.prices }) },
  { id: 'portfolio-opt-lab', name: 'Portfolio Optimization Lab', category: 'portfolio', component: PortfolioOptLab,
    props: (ctx) => ({ sendSignalMessage: ctx.signals.sendSignalMessage, portfolioResult: ctx.signals.portfolioResult, connected: ctx.signals.connected, candles: ctx.exchange.candles, symbols: ctx.SYMBOLS, exchange: ctx.selectedExchange, accounts: ctx.exchange.accounts, prices: ctx.exchange.prices }) },
  { id: 'black-swan-tester', name: 'Black Swan Tester', category: 'risk', component: BlackSwanTester,
    props: (ctx) => ({ candles: ctx.exchange.candles, accounts: ctx.exchange.accounts, prices: ctx.exchange.prices, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange }) },

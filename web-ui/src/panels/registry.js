...
export const PANELS = [
  ...
  { id: 'funding-history', name: 'Funding Rate History', category: 'technical', component: FundingRateHistory,
    props: (ctx) => ({ fundingRates: ctx.exchange.fundingRates, candlesToFunding: ctx.exchange.candlesToFunding, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange, prices: ctx.exchange.prices, symbols: ctx.SYMBOLS, sendSignalMessage: ctx.signals.sendSignalMessage, fundingArbResult: ctx.signals.fundingArbResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'risk-dashboard', name: 'Risk Dashboard (VaR/CVaR)', category: 'risk', component: RiskDashboard,
    props: (ctx) => ({ accounts: ctx.exchange.accounts, candles: ctx.exchange.candles, symbols: ctx.SYMBOLS, exchange: ctx.selectedExchange, prices: ctx.exchange.prices, sendSignalMessage: ctx.signals.sendSignalMessage, stressTestResult: ctx.signals.stressTestResult, signalsConnected: ctx.signals.connected }) },
  ...
  { id: 'inventory', name: 'Inventory Manager', category: 'portfolio', component: Inventory,
    props: (ctx) => ({ accounts: ctx.exchange.accounts, prices: ctx.exchange.prices, candles: ctx.exchange.candles, exchange: ctx.selectedExchange, symbol: ctx.selectedSymbol }) },
  ...
  { id: 'tca', name: 'Transaction Cost Analysis', category: 'risk', component: TCA,
    props: (ctx) => ({ fills: ctx.exchange.fills, candles: ctx.exchange.candles, symbol: ctx.selectedSymbol, exchange: ctx.selectedExchange, currentPrice: ctx.currentPrice }) },
  ...
  { id: 'realtime-attribution', name: 'Realtime PnL Attribution', category: 'portfolio', component: RealtimeAttribution,
    props: (ctx) => ({ fills: ctx.exchange.fills, accounts: ctx.exchange.accounts, prices: ctx.exchange.prices, candles: ctx.exchange.candles }) },
  ...
  { id: 'signal-tracker', name: 'Signal Tracker', category: 'strategy', component: SignalTracker,
    props: (ctx) => ({ signals: ctx.signals.signals, fills: ctx.exchange.fills, candles: ctx.exchange.candles, prices: ctx.exchange.prices }) },
  ...
  { id: 'arb-scanner', name: 'Arbitrage Scanner', category: 'strategy', component: ArbScanner,
    props: (ctx) => ({ arbitrage: ctx.exchange.arbitrage, prices: ctx.exchange.prices }) },
]

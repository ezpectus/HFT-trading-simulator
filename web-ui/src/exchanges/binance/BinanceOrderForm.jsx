...
import { BinanceButton, BinanceCard } from './BinanceTheme'
...
export default function BinanceOrderForm({ 
  ...
  return (
    <BinanceCard className="p-4">
      ...
      <div className="flex gap-2 mb-4">
        <button
          ...
          className={`flex-1 py-2 rounded font-medium transition-all ${
            side === 'buy' ? 'text-black' : 'text-gray-400 hover:text-gray-200'
          }`}
          style={{
            backgroundColor: side === 'buy' ? theme.success : '#1E2329',
          }}
        >
          Buy
        </button>
        <button
          ...
          style={{
            backgroundColor: side === 'sell' ? theme.danger : '#1E2329',
          }}
        >
          Sell
        </button>
      ...
      <div className="flex gap-1 mb-4 flex-wrap">
        {['market', 'limit', 'stop_limit', 'trailing_stop', 'iceberg'].map((type) => (
          <button
            ...
            style={{
              backgroundColor: orderType === type ? theme.primary : '#1E2329',
            }}
          >
      ...
      {/* Advanced options */}
      {showAdvanced && (
        <div className="mb-4 p-3 rounded" style={{ backgroundColor: '#1E2329' }}>
          <div className="mb-2">
            <label className="block text-xs mb-1" style={{ color: theme.textSecondary }}>
              Stop Loss
            </label>

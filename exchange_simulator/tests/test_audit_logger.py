...
def _close_audit_loggers(monkeypatch):
    """Close every AuditLogger created during a test — the rotating file
    sink holds the log file open (blocks dir teardown on Windows)."""
    created = []
    ...
    monkeypatch.setattr(AuditLogger, "__init__", tracking_init)
    yield
    for al in created:
        al.close()
...
class TestAuditLogger:
    ...
    def test_log_file_persistence(self, tmp_path):
    ...
    def test_get_logs_all(self, tmp_path):
    ...
    def test_get_logs_filter_by_event_type(self, tmp_path):
    ...
    def test_get_logs_filter_by_exchange(self, tmp_path):
    ...
    def test_get_logs_filter_by_symbol(self, tmp_path):
    ...
    def test_get_logs_filter_by_time_range(self, tmp_path):
    ...
    def test_get_order_lifecycle(self, tmp_path):
    ...
    def test_get_position_lifecycle(self, tmp_path):

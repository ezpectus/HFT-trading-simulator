...
struct alignas(64) FastSignal {
    ...
    bool is_actionable() const { return direction != Direction::NEUTRAL; }
...
struct alignas(64) FastOrder {
    enum class OrderKind : uint8_t { MARKET, LIMIT_IOC, LIMIT_FOK, LIMIT_GTD, POST_ONLY };
    ...
    const char* kind_str() const {
        ...
        case OrderKind::MARKET:
            return "MARKET";
        case OrderKind::LIMIT_IOC:
            return "IOC";
        case OrderKind::LIMIT_FOK:
            return "FOK";
        case OrderKind::LIMIT_GTD:
            return "GTD";
        case OrderKind::POST_ONLY:
            return "POST_ONLY";
        }
        return "UNKNOWN";
    }

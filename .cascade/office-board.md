...
| Всего находок | ~121 (S001–S120 + переименованные) |
| Закрыто | 83 (+S119, S120) |
| Открыто | 2 (S116 auth — wire-or-delete; S117 dead portfolio/pricing modules) |

**Главный вывод:** после 38 раундов открыты только S116+S117 (оба — wire-or-delete решения). R38 нашёл: обе options-панели были crash-on-render мертвы (Math.erf нет в JS, Math.pi→NaN-греки, TDZ-shadow, инвертированный знак премии iron condor + theta yr-vs-day дрейф) — всё исправлено, +8 контракт-тестов.

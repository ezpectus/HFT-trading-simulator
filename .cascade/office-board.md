...
| Закрыто | 221 |
| Открыто | **5** — R105: S197–S199 · R106: S200–S202 · R107: S203–S206 · R108: S207–S209 · R109: S210/S211 · R111: S212–S219 · R112: S220–S223 · R113: S224–S227 · R114: S228/S229 · R115: S230–S238 · R116: S239–S242 · R117: S243–S252 · R118: S253–S258 · R119: S259–S262 · R120: S263–S265 · R121: S266–S268 · R122: S269–S271 · R123: S272/S273 · R124: S274–S276 · R125: S277/S278 · R126: S279/S281 · R127: S282/S283 · R128: S284 · R129: S285/S286 · R130: S287 · R131: S288/S289 · R132: S290–S293 · R133: S294–S297 · R134: S298–S301 · R135: S303 · R136: — (clean after S306) · R137/R138: — (clean) · R139: S307/S308 · R140: — (clean) · R141: S309 · R142: — (clean) · R143: S310–S312 · R144: S313 · R145: S314–S317 |

**Текущее состояние:** R179 slop-audit — docs/ leaf-read: 4 новых Info-находки (S318–S321) — всё docs-drift класс: CONFIGURATION_GUIDE документирует вырезанные S316-секции shared_config, TRADING_STRATEGIES покрывает половину ансамбля, PERFORMANCE несёт un-runnable benchmark-команды и measured-латентность несуществующего REST API, docker-compose v1 по всем командным докам. Board: 5 open — S309 Medium (Docker-blocked) + 4 Info.
...
| **S318** | `CONFIGURATION_GUIDE.md` документирует удалённые секции shared_config | `docs/guides/CONFIGURATION_GUIDE.md:59-118` — разделы `system:` (name/version/mode), `default_exchange:`, `timeframe:`/`timeframe_seconds:`, `account:` описаны как живые ключи — все четыре вырезаны из `shared_config.yaml` в S316/R170 (там теперь только symbols/exchanges/risk/websocket). Плюс «50 cryptocurrency pairs» (:69) — реально 49. Читатель правит секции файла, которых нет. | Info | [ ] Open |
| **S319** | `TRADING_STRATEGIES.md` описывает 3 из 6 wired-стратегий | Detailed-секции есть только у TrendFollowing/MeanReversion/FFTCycle (+Ensemble Voter); `MarketMakingStrategy`, `MLEnsembleStrategy`, `SentimentStrategy` — все три wired в `bot_helpers.py:54-63` — ни одной секции. Sentiment упомянута мимоходом в overview. Документ стратегий молчит про половину ансамбля. | Info | [ ] Open |
| **S320** | `PERFORMANCE.md` — un-runnable benchmark-команды + измерения несуществующего | C++ methodology блок — 3 фантома: `./hft_trade_bot --config ...` (реально positional `argv[1]`, bot_setup.cpp:58), `--enable-latency-histograms` (нет такого флага — yaml-ключ `latency_histogram_enabled`), `cmake -DENABLE_PROFILING=ON` (нет такого option — реально `-DUSE_PGO=ON`+`Profile` build). Строка «REST API (exchange simulator) 5-20ms ~10ms» — measured-латентность API которого нет (S283/S074). «5 strategies» ×2 — wired 6. «Measured»-колонка не производится ничем — `benchmark_suite.py` (S214 toy-theater) всё ещё приведён как источник. | Info | [ ] Open |
| **S321** | `docker-compose` v1 синтаксис по всем command-докам | `DEPLOYMENT.md` ×14, `QUICK_START.md` ×7, `README.md` ×2 — везде `docker-compose build/up/ps/logs/down` — EOL v1-бинарь (S302 починил Makefile, доки остались). На машине без v1-алиясы каждая команда падает. ~23 сайта. | Info | [ ] Open |
...
2. Info-пачка (R179): S318 (CONFIGURATION_GUIDE shared_config drift), S319 (TRADING_STRATEGIES половина ансамбля), S320 (PERFORMANCE un-runnable benchmarks), S321 (docker-compose v1 docs).

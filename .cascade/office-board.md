...
| Закрыто | 230 |
| Открыто | **9** — R191 bloat: S322–S327 · R192 domain-math: S328 · R193: S333 · R194: S336 (S329/S332/S337/S340 → R200 · S338/S339 → R201 · S330/S331/S334/S335 → R202) |
...
1. ~~S337~~ ~~S329+S332~~ ~~S340~~ (R200) ~~S338/S339~~ (R201) ~~S330/S331~~ ~~S334/S335~~ (R202) — все High + все Medium fill-model/C++ закрыты. Осталось 2 Medium + Low/Info.
2. **S322** (Medium, R191) — copy-paste venue-runners ×3. **S328** (Medium, R192) — мёртвый backtest-стек ~580 строк.
3. Low: **S323** close-block ×2 · **S324** фейковая Retry-кнопка · **S325** stress_test tail ×4. Info: **S326** metrics-таблица · **S327** dispatch-map · **S333** round(·,2)+дубль константы · **S336** hdl ordering.

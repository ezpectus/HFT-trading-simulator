...
| **S200** | `index.html` meta — докучные числа (204 panels/44+ models), мимо фикса S160 | `web-ui/index.html:6` + `:12` — `<meta name="description">` и `og:description` говорят «204 panels, 44+ math models»; S160 обновил манифест в `vite.config.js` на 278/44+, но head не тронул — поисковая выдача и соцпревью несут устаревшие числа. Привести к манифесту (или единому источнику). 2 тега. | Info | [ ] Open |

...
| 49 | 2026-08-23 | Пачка VV — var_stress_test.py: added DeprecationWarning (duplicates var.py + cvar.py + stress_test.py). test_var_stress_test.py: added filterwarnings marker + deprecation test. CODE_AUDIT §1.2, §1.3 marked [FIXED]. Files: 4 changed (2 source + 2 docs) | ✅ Done | — |

...
| 69 | 2026-08-23 | Пачка AK-prev — BinanceAdapter.h: consolidated price_lock_ + depth_lock_ into single market_data_lock_ (§8.203/§8.462). can_send_order: replaced fetch_add with CAS loop — only increments if below 300 threshold (§8.204). §8.420 prices_cache already fixed (prices_cache_lock Spinlock). §8.176/§8.419 3 signal engines N/A (all actively used: V2=main, V3=HMM, V1=fallback). CODE_AUDIT §§8.203, 8.204, 8.420, 8.462 marked [FIXED], §§8.176, 8.419 marked [N/A]. Files: 4 changed (1 source + 3 docs) | ✅ Done | — |

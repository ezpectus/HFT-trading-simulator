...
ШАГ 1: СБОР КОНТЕКСТА — CEO (01)
  ...
  2. .cascade/progress.md — что уже сделано
  3. .cascade/notes.md — контекст и TODO
  4. CHANGELOG.md — последние изменения
  5. .cascade/bug_log.md — известные баги
  6. README.md — текущее состояние проекта
...
ШАГ 3: АНАЛИЗ ПЛАНА РАЗРАБОТКИ — CTO (02) + VP Eng (04)
  ...
  → Список НЕЗАВЕРШЁННЫХ задач из плана → основной фокус спринта

  VP Eng (04) — анализ архитектуры:
  ...
  10. Проверь: соответствуют ли файлы плану?
  → Несоответствия → задачи на разработку
...
ШАГ 6: ВЫПОЛНЕНИЕ ЗАДАЧ СПРИНТА
  ...
  3. Прочитай related код (read_file, grep_search)
  4. Реализуй (edit, multi_edit, write_to_file)
  5. Проверь (read_file после edit — ОБЯЗАТЕЛЬНО)
  6. Тесты (БЛОК 5)
  7. Документация (БЛОК 7)
  8. Коммит (БЛОК 6)
